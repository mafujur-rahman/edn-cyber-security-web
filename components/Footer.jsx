                        ...
                        <div className="padding-vertical padding-96">
                            <div className="vflex-center text-align-center">
                                <div className="flotteur_footer">
                                    <img 
                                        src="images/68953ae6dd69263dad027790_18fd806485877494cfa4675886a347f7_HD_Intro_00000.webp" 
                                        loading="lazy" 
                                        sizes="100vw" 
                        ...
                        <div data-w-id="7b64abaf-86df-9a08-a92d-c7f99712a339">
                                    ...
                                    <div>
                                        <div className="margin-bottom margin-64">
                                            <a href="#" className="w-inline-block">
                                                <img src="images/6894d99e4c33d996091e62ff_32e54c129a2d219d7db73c0460dbaf8f_logo-mokn.svg" loading="lazy" alt="MokN Logo" />
                                            </a>
                                        </div>
                                        <div className="hflex-left-center gap-16">
                                            <a href="https://www.linkedin.com/company/mokn/" target="_blank" className="social_links w-inline-block" rel="noopener noreferrer">
                                            ...
                                            <a href="https://www.instagram.com/mokn.io/" target="_blank" className="social_links w-inline-block" rel="noopener noreferrer">
                                                <div className="svg w-embed">
                                                    <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <a href="https://www.facebook.com/people/MokN/61578289934052/" target="_blank" className="social_links w-inline-block" rel="noopener noreferrer">
                                                <div className="svg w-embed">
                            ...
                            <div className="padding-bottom padding-80">
                                ...
                                <div className="hflex-between-center z-index-1 gap-16">
                                    <div className="text-regular">© 2025 MokN. All rights reserved.</div>
